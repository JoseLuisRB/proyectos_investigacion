...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ url('landingpage/assets/img/logo.jpg') }}" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="/"> <img src="{{ url('landingpage/assets/img/logo.jpg') }}" alt="UAB"></a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h2>Sistema de administración y consulta de investigaciones de la U.A.B.</h2>
          <div class="d-flex">
        ...
        <div class="container">
            ...
            <div class="row counters">
                ...
                <div class="col-lg-3 col-6 text-center">
                    <span data-purecounter-start="0" data-purecounter-end="{{ $count }}" data-purecounter-duration="1" class="purecounter" style="border: 2px solid #dedede; border-radius: 10px"></span>
                    <b>{{ $item->nombre }}</b>
                </div>
                @endforeach
            </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-6">
            ...
            <p>Puedes suscribirte a nuestra plataforma para recibir noticias acerca de los últimos proyectos que se llevan acabo.</p>
          </div>
        </div>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>U.A.B J.B. {{ date('Y') }}</span></strong>. Todos los derechos reservados
      </div>
      <div class="credits">
