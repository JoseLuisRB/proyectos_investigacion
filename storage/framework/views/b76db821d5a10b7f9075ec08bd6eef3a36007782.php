				            ...
				            <div class="col-md-12 relationship_details">
				                ...
				                <select class="relationship_table select2" name="relationship_table">
				                    <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				                        <option value="<?php echo e($tbl); ?>" <?php if(isset($relationshipDetails->table) && $relationshipDetails->table == $tbl): ?><?php echo e('selected="selected"'); ?><?php endif; ?>><?php echo e(\Illuminate\Support\Str::singular(ucfirst($tbl))); ?></option>
...
<?php /**PATH C:\xampp\htdocs\proyectos\vendor\tcg\voyager\src/../resources/views/tools/bread/relationship-new-modal.blade.php ENDPATH**/ ?>