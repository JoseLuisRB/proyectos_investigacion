        ...
        <?php if($options->type == 'belongsTo'): ?>
            ...
            <?php else: ?>
                ...
                <select
                    ...
                    data-method="<?php echo e(isset($dataTypeContent) ? 'edit' : 'add'); ?>"
                >
                    <?php
                        $model = app($options->model);
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyectos\vendor\tcg\voyager\src/../resources/views/formfields/relationship.blade.php ENDPATH**/ ?>