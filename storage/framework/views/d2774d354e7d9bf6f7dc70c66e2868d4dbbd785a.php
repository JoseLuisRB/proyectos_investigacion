...
<ol class="breadcrumb hidden-xs">
    ...
    <li class="active">
        ...
        <?php else: ?>
        <a href="<?php echo e(route('voyager.bread.create', ['name' => $table])); ?>">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           value="<?php echo e($dataType->display_name_singular ?? $display_name); ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           value="<?php echo e($dataType->display_name_plural ?? $display_name_plural); ?>">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyectos\vendor\tcg\voyager\src/../resources/views/tools/bread/edit-add.blade.php ENDPATH**/ ?>