    ...
    <script>
        $(document).ready(function () {
            ...
            $('.item_actions').on('click', '.delete', function (e) {
                ...
                $('#delete_form')[0].action = '<?php echo e(route('voyager.menus.item.destroy', ['menu' => $menu->id, 'id' => ''])); ?>/' + id;
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyectos\vendor\tcg\voyager\src/../resources/views/menus/builder.blade.php ENDPATH**/ ?>