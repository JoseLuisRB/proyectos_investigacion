            ...
            <div class="login-container">
                ...
                <form action="<?php echo e(route('voyager.login')); ?>" method="POST">
                    ...
                    <div class="form-group" id="rememberMeGroup">
                        <div class="controls">
                        <input type="checkbox" name="remember" value="1"><span class="remember-me-text"><?php echo e(__('voyager::generic.remember_me')); ?></span>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\proyectos\vendor\tcg\voyager\src/../resources/views/login.blade.php ENDPATH**/ ?>